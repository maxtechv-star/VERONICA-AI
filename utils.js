...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://terrizev_qlo9_user:0ZWQEdBFfzAOPiH3A1h9tdOTEgadXlbX@dpg-cv8bua9mbjs5s2t9ud80-a.oregon-postgres.render.com/terrizev_qlo9';
...
// Sync database
AuthState.sync({ alter: true })
    .then(() => console.log('✅ AuthState table synced'))
    .catch(err => console.error('❌ AuthState sync error:', err));
